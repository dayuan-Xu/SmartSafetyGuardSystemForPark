...
async def read_camera_info(
    ...
    return await CameraInfoService.get_camera_info(db, camera_info_id)
...
async def search_camera_infos(
    ...
    - limit: 分页参数，限制返回的记录数
    """
    return await CameraInfoService.get_camera_infos_with_condition(
...
async def read_all_camera_infos(
    ...
    return await CameraInfoService.get_all_camera_infos(db, skip=skip, limit=limit)
...
async def create_new_camera_info(
    ...
    return await CameraInfoService.create_camera_info(db, camera_info)
...
async def update_existing_camera_info(
    ...
    return await CameraInfoService.update_camera_info(db, camera_info_id, camera_info_update)
...
async def remove_camera_info(
    ...
    return await CameraInfoService.delete_camera_infos(db, camera_info_ids)
...
async def test_camera_connection(camera_id: str = "6", db: Session = Depends(get_db)):
    return await CameraInfoService.test_camera_connection(camera_id, db)
