...
@router.post("/token", response_model=Result[Token], summary="用户登录认证", tags=["注册登录"])
...
@router.post("/register", response_model=Result, status_code=status.HTTP_201_CREATED, summary="用户注册", tags=["注册登录"])
